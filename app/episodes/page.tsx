...
export const metadata: Metadata = {
  title: "اپیزودها | کومان - Kouman",
  description: "تماشای اپیزودهای کومان",
};
...
export default function EpisodesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8">
      <h1 className="text-4xl font-bold text-center mb-3">اپیزودها</h1>
      <p className="text-center text-gray-600 mb-10">
        جدیدترین اپیزودهای کومان — هر جمعه یک چالش تازه!
      </p>
      ...
      <div className="px-6 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {videos.map((video) => (
            <div
              key={video.id}
              className="group bg-white rounded-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
            >
              ...
              <div className="p-4 flex flex-row-reverse justify-between items-center">
                ...
                <h2 className="text-base font-medium line-clamp-2 text-right group-hover:text-orange-600 transition-colors">
                  {video.title}
                </h2>
              </div>
            </div>
